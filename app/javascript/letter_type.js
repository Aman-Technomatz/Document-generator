document.addEventListener("DOMContentLoaded", function () {
  function toggleDocumentFields() {
    ...
    switch (docType) {
      case "appointment_letter":
        document.getElementById("appointment_letter_fields").style.display =
          "block";
        ...
        document
          .querySelectorAll("#appointment_letter_fields input")
          .forEach(function (input) {
            input.setAttribute("required", "true");
          });
        break;
  ...
  function calculateTotals() {
    const basicSalary =
      parseFloat(document.getElementById("basic-salary")?.value) || 0;
    const hra = parseFloat(document.getElementById("hra")?.value) || 0;
    const incomeTax =
      parseFloat(document.getElementById("income-tax")?.value) || 0;
    const providentFund =
      parseFloat(document.getElementById("provident-fund")?.value) || 0;
    const otherAllowance =
      parseFloat(document.getElementById("oa")?.value) || 0;
  ...
  document
    ...
    .addEventListener("change", toggleDocumentFields);
